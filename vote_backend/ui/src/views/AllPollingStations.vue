<template>
    <div class="">
      ...
      <div class="flex flex-row justify-between items-center w-full">
        <div>
          <p class="px-12">Polling Stations</p>
        </div>

        <div class="flex flex-row px-12">
          <router-link :to="{ name: 'polling-stations' }" @click="$router.go()" class="flex items-center p-2">
            <img src="../assets/images/refresh.svg" class="w-6 h-8">
          </router-link>

          <router-link :to="{ name: 'new-polling-station' }" class="flex items-center p-2">
            <img src="../assets/images/add.svg" class="w-6 h-8">
                ...
                <table class="table-auto space-y-6">
                    ...
                    <tr v-for="(data, i) in this.allPollingStations"  :key="data" class="bg-white border-b">
